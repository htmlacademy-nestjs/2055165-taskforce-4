...
@Module({
  imports: [
    ConfigModule.forRoot({
      cache: true,
      load: [usersAppConfig, authAppConfig, feedbacksAppConfig, fsAppConfig],
      envFilePath: [ENV_USERS_FILE_PATH, ENV_AUTH_FILE_PATH, ENV_FEEDBACKS_FILE_PATH, ENV_FS_FILE_PATH]
    })
  ],
